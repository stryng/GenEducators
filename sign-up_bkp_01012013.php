...
<?php
		...
		$form->fields 			=  array(
			...
			"Inviter ID"  		=> array("name"=>"inviter","type"=>"text","class"=>"lname", "value"=>$inviter,"onblur"=>"valid_inviter();","hint"=>'<div id="inviter_errorloc" style="left: 0px;display:none;position: relative;top: 0px;background: white;color: GREEN;text-shadow: none;width:360px;border-radius : 6px;text-align:justify;height:auto;padding:5px;"></div><div class="clear"></div>'),
