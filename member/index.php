...
<!-- <script type='text/javascript' src='js/src/_loader.js'></script>-->
...
<?php 
			...
			{ 
		 	...
		 	if(isset($_GET['file'])) 
			{
				include_once MEMBER_PATH."middle/".$_REQUEST['file'].'.php';
			}
			else 
			{
				include_once MEMBER_PATH."middle/welcome.php";
			}	
		?>
<?php 
			if($_GET['file']!='login')
