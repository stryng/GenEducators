<?php
	...
	$msg = "";
?>
<script type="text/javascript" src="js/ajax_volunteers.js">
</script>
...
<?
	if($marics == "33")
	{
		$qry = "select * from nodetree where usertb_id= '".$_SESSION['userid']."'";
		$row_u = $form->getRow($qry);

		$qry = "select * from nodetree where u1 = '".$_SESSION['userid']."' or u2 = '".$_SESSION['userid']."' or u3 = '".$_SESSION['userid']."'";
		...
		if($_SESSION['notintree'][$_SESSION['userid']] == false)
		{
	...
	{
		$qry = "select * from nodetree_5_3 where usertb_id= '".$_SESSION['userid']."'";
		$row_u = $form->getRow($qry);

		$qry = "select * from nodetree_5_3 where u1 = '".$_SESSION['userid']."' or u2 = '".$_SESSION['userid']."' or u3 = '".$_SESSION['userid']."' or u4 = '".$_SESSION['userid']."' or u5 = '".$_SESSION['userid']."' or usertb_id = '".$_SESSION['userid']."'";
		$row_out = $form->getRow($qry);
		if(sizeof($row_out)>0)
		{
			$_SESSION['notintree_5_3'][$_SESSION['userid']] = false;
		}
		else if(sizeof($row_u)==0)
		{
			$_SESSION['notintree_5_3'][$_SESSION['userid']] = false;
		}
		if($_SESSION['notintree_5_3'][$_SESSION['userid']] == false)
		{
	...
	{
		$qry = "select * from nodetree_10_3 where usertb_id= '".$_SESSION['userid']."'";
		$row_u = $form->getRow($qry);

		$qry = "select * from nodetree_10_3 where u1 = '".$_SESSION['userid']."' or u2 = '".$_SESSION['userid']."' or u3 = '".$_SESSION['userid']."' or u4 = '".$_SESSION['userid']."' or u5 = '".$_SESSION['userid']."' or u6 = '".$_SESSION['userid']."' or u7 = '".$_SESSION['userid']."' or u8 = '".$_SESSION['userid']."' or u9 = '".$_SESSION['userid']."' or u10 = '".$_SESSION['userid']."' or usertb_id = '".$_SESSION['userid']."'";
		$row_out = $form->getRow($qry);
		if(sizeof($row_out)>0)
		{
			$_SESSION['notintree_10_3'][$_SESSION['userid']] = false;
		}
		else if(sizeof($row_u)==0)
		{
			$_SESSION['notintree_10_3'][$_SESSION['userid']] = false;
		}
		if($_SESSION['notintree_10_3'][$_SESSION['userid']] == false)
		{
