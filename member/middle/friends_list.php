<?php
	...
	$rtn_type .= " AND inviter='".$_SESSION['userid']."'";
	$form = new Form();
...
<div id="content">
        ...
        <?
			...
			$num_totrec = $obj->count_member_detail($tableName,$_SESSION['userid']);
			...
			$db_res = $obj->get_member_detail($tableName, $sorton, $sorttype,$var_limit,$_SESSION['userid']);
			*/
		...
		?>
			...
			<div class="tablePars">
				<div class="dataTables_filter set_tble_search"> 
				  <div>
                 	<form  name="searchform" id="searchform" method="post" action="index.php?file=friends_list<?=$str_url?>"> 
							<div class="floatleft"> 
