<?php
	...
	$sql_3 = mysql_fetch_array(mysql_query("select count(*) as tot  from message_in where msg_status='2' and to_u_id = '".$_SESSION['userid']."' AND to_admin='no'"));
	...
	$replysql = "select *  from message_in where msg_status='2' and to_u_id = '".$_SESSION['userid']."' AND to_admin='no' ORDER BY status desc,msg_datetime desc ".$var_limit3;	 	
