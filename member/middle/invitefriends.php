<?php
$qry = "select * from userdetail where UserId = '".$_SESSION['userid']."' and active =1 and entry='prepaid' ";
$row = $form->getRow($qry);
$msg = "";
		...
		$form->fields 			=  array(
			"userlink"  		=> array("name"=>"userlink","type"=>"hidden","save2db"=>"false", "value"=>SERVER_URL."sign-up.php?inviter=".$_SESSION['userid'],"hint"=>'<a style="color:#000099;" href="'.SERVER_URL.'sign-up.php?inviter='.$_SESSION['userid'].'" target="_blank" >'.SERVER_URL.'sign-up.php?inviter='.$_SESSION['userid'].'</a>'),
						...
						<form id="form1" name="form1" action="" method="post" class="myform">
                            <div style="margin-left:25px">
								...
								if($str_msg == "")
								{
									...
									?>
									<div class="fieldbox">
										<input class="buttonH button_green" type="submit" value="Submit"  />
