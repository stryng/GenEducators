                                            	...
                                            	<ul class="left top_move" id="ul_volunteers_name" style="display:none;">
                                                	<li class="float_left_mar">
       												<?
														...
														{
														?>
															<div class="floatleft"><a id="volunteers_expand1" class="acolor" href="javascript:void(0);" onclick="addmore_volunteers_name1(<?=$user4_id?>,1,'volunteers_expand1')"><?=($user4_name!='')?'+&nbsp;&nbsp;':'+&nbsp;&nbsp;' ?></a><?=$user4_name?></div>
														<?
														}
														else
														{
                                                    ...
                                                    <li class="float_left_mar">
     												<?
														...
														{
														?>
															<div><a id="volunteers_expand2" class="acolor" href="javascript:void(0);" onclick="addmore_volunteers_name1(<?=$user5_id?>,2,'volunteers_expand2')"><?=($user5_name!='')?'+&nbsp;&nbsp;':'+&nbsp;&nbsp;' ?></a><?=$user5_name?></div>
														<?
														}
														else
														{
                                                    ...
                                                    <li class="float_left_mar">
     												<?
														...
														{
														?>
															<div class="floatleft"><a id="volunteers_expand3" class="acolor" href="javascript:void(0);" onclick="addmore_volunteers_name1(<?=$user6_id?>,3,'volunteers_expand3')"><?=($user6_name!='')?'+&nbsp;&nbsp;':'+&nbsp;&nbsp;' ?></a><?=$user6_name?></div>
														<?
														}
														else
														{
