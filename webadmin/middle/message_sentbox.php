<?php
	...
	$sql_2 = mysql_fetch_array(mysql_query("select count(*) as tot from message_in where userid = '".$_SESSION['admin']['userid']."' AND to_admin='yes' "));
	...
	$sentsql = "select *  from message_in where userid = '".$_SESSION['admin']['userid']."' AND to_admin='no' ORDER BY status desc,msg_datetime desc ".$var_limit2;	 
