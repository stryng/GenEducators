...
<?php
		...
		$form = new Form();
		$getid = isset($_GET['userid'])?$_GET['userid']:1;
		...
		$form->fields 				=  array(
			...
			"User Email"			=> array("name"=>"Email","type"=>"text","readonly"=>"yes","save2db"=>"false", "validate"=>"R","onchange"=>"check_space(this)","onblur"=>"set_loginval(this)","hint"=>'<img id="tick" src="images/tick.png" width="16" height="16" /><img id="cross" src="images/cross.png" width="16" height="16" />We will send you the e-mail confirmation for account activation.'),
