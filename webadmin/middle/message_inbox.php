<?php
	...
	$sql_c = mysql_fetch_array(mysql_query("select count(*) as tot from message_in where msg_status='1' and to_u_id = '".$_SESSION['admin']['userid']."' AND to_admin='yes' "));
	...
	$inboxsql = "select *  from message_in where msg_status='1' and to_u_id = '".$_SESSION['admin']['userid']."' AND to_admin='yes' ORDER BY status desc,msg_datetime desc ".$var_limit;	
