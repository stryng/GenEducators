...
spinnerIncDecOnly: true // Only up and down arrows
	...
	$('a.location').mouseenter(function () {
		$('.sub_location').show(200);
		$('.sub_tracking').hide(200);
		$('.submessageclass').hide(200);
	});
	$('a.support').mouseenter(function () {

		$('.sub_support').show(200);
		$('.sub_tracking').hide(200);
	});
		
	$('.sub_support').mouseleave(function () {
		$('.sub_support').hide(200);
		$('.sub_tracking').hide(200);
	});

	
	$('ul.sub_location').mouseleave(function () {
...
$("#day1_start").timeEntry('disable');
$("#day1_end").timeEntry('disable');
$("#day2_start").timeEntry('disable');
$("#day2_end").timeEntry('disable');
$("#day3_start").timeEntry('disable');
$("#day3_end").timeEntry('disable');
$("#day4_start").timeEntry('disable');
$("#day4_end").timeEntry('disable');
$("#day5_start").timeEntry('disable');
$("#day5_end").timeEntry('disable');
$("#day6_start").timeEntry('disable');
$("#day6_end").timeEntry('disable');
$("#day7_start").timeEntry('disable');
$("#day7_end").timeEntry('disable');
