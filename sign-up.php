...
<script language="javascript">
...

	{
		...
		if(document.getElementById('inviter').value != "")
...

		{
			...
			document.getElementById('inviter').value = 1;
...
<?php
		...
		$form->fields 			=  array(
			...
			"Inviter ID"  		=> array("name"=>"inviter","type"=>"text","class"=>"lname", "value"=>$inviter,"onblur"=>"valid_inviter();","hint"=>'<div id="inviter_errorloc" style="left: 0px;display:none;position: relative;top: 0px;background: white;color: GREEN;text-shadow: none;width:270px;border-radius : 6px;text-align:justify;height:auto;padding:5px;"></div><div class="clear"></div>'),
			...
			"Middle Name"		=> array("name"=>"MiddleName","type"=>"text","class"=>"lname", "onblur"=>"check_space(this)"),
			...
			"Balance"				=> array("name"=>"Balance","value"=>"33", "type"=>"text","class"=>"lname","readonly"=>"yes","validate"=>"R","save2db"=>"false","hint"=>'You have 48 Hrs to confirm your payment in the back office or your position will be deleted and<br> you will have to re enroll for a new position.'),
				...
				if(sizeof($rows)>0) {
					...
					*/
					...
					<script type="text/javascript">
						...
						window.location = "withoutpayment_confirmation.php?email=<?=$_POST['Email']?>&userid=<?=$users_id?>";
...
<!-- Content begins -->
	...
	<script type="text/javascript">
...

				{
					...
					else if (document.form1.valid.checked == false) 
      ...
      <div id="content">
           		 ...
           		 <form id="form1" name="form1" action="" method="post" class="myform">
				 	...
				 	<div style="margin-left:0px">
...

						{
							...
							?>
							<div class="aggre_check"><input type="checkbox" name="valid" value="yes"> I agree with <a target="_blank" href="term-of-service.php">Terms and Conditions</a></div>
							<div class="fieldbox">
		...
		<div class="twothird_box2">
			...
			<div class="twothird_box_inner">
					...
					<div id="userlistsupdate">

						<h3  class="H2cls">Total Members: <?php echo $numSup; ?></h3>
						
						<iframe src="scroll.php" width="180" height="215" border="0" style="overflow:hidden; border:0px;" scrolling="no" frameborder="0" marginwidth="0" marginheight ="0" allowtransparency="1">
...
<script type="text/javascript">
	...
	//setInterval(getNewUserList,3000);
